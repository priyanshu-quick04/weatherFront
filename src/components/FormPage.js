    ...
    <>
      <div className="flex md:flex-row flex-col justify-center px-8 py-10 bg-gray-950">
        <div className="flex flex-col items-center justify-center border-4 border-yellow-400 rounded-lg px-5 py-5 space-y-6 md:mr-5 mr-0 mb-5">
          <div
            className="text-slate-500 text-2xl font-mono font-semibold md:w-[480px] w-[100%] text-center border-2
         border-sky-400 rounded-md px-4 py-3"
          ...
          <div
            className="text-slate-300 text-2xl font-serif font-semibold md:w-[480px] w-[100%] text-center border-2
         border-sky-400 rounded-md px-4 py-3"
          >
            Type a place, unveil its weather. Simple as that!
          </div>
        </div>
        <div className="flex flex-col items-center justify-between border-4 border-purple-400 rounded-lg py-10 px-6 mb-5 space-y-4">
          <div className="flex flex-row font-sans text-lg font-semibold md:space-x-2 space-x-4 w-full justify-between">
            ...
            <input
              ...
              name="place"
              value={detail.place}
              className="bg-gray-900 border-2 border-blue-300 rounded-2xl px-2 w-[100%]"
